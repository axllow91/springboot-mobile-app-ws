...
public class AmazonSES {
    ...
    final String FROM = "dobremi91@gmail.com";
    ...
    final String PASSWORD_RESET_HTML_BODY = "<h1>A request to reset your password</h1>" +
            ...
            + "otherwise please open the link below to set a new password: "
    ...
    public void verifyEmail(UserDto userDto) {
        ...
        // You can also set your keys with way. and it will work!
        // System.setProperty("aws.accessKeyId", "<YOUR KEY ID HERE>");
        // System.setProperty("aws.secretKey", "<YOUR SECRET KEY HERE>");
        ...
        // add the token in html body
        String htmlBodyWithToken = HTMLBODY.replace("$tokenValue", userDto.getEmailVerificationToken());
        String textBodyWithToken = TEXTBODY.replace("$tokenValue", userDto.getEmailVerificationToken());

        // send email request with destination of user email
        // with html body token and text body token
        // from email
    ...
    public boolean sendPasswordResetRequest(String firstName, String email, String token) {
        ...
        // replace string in html and text body
